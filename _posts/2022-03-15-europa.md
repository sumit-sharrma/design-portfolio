...
<div class="hero-block">
    <img src="{{ site.europa.bg }}" alt="Europa hero image" />
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.audit-1 }}" alt=""/>
</div>

<div class="post-section-img">
    <img src="{{ site.europa.audit-2 }}" alt=""/>
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.colors }}" alt=""/>
</div>

<div class="post-section-img post-section-img-col">
    <img src="{{ site.europa.color-palette }}" alt=""/>
...
<div class="post-section-img">
    <img src="{{ site.europa.typography }}" alt=""/>
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.spacing }}" alt=""/>
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.button }}" alt=""/>
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.other-comp }}" alt=""/>
</div>
...
<div class="post-section-img">
    <img src="{{ site.europa.documentation }}" alt=""/>
</div>
